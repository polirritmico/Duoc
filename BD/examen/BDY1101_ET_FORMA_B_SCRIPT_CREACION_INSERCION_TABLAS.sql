...
--
-- ET BDY1101
-- Bases de Datos Aplicada I
-- Profesor Ernesto Leonidas
-- 016V
-------------------------------------------------------------------------------
...
-- MUNICIPALIDADES
INSERT INTO municipalidades VALUES (1, 'Municipalidad de Providencia', 1);
INSERT INTO municipalidades VALUES (2, 'Municipalidad de Viña del Mar', 2);
INSERT INTO municipalidades VALUES (3, 'Municipalidad de San Pedro de la Paz', 3);

-- CENTROS DE EVENTOS
INSERT INTO centros_eventos VALUES (1, 'Teatro Providencia', 1);
INSERT INTO centros_eventos VALUES (2, 'Teatro Municipal Valpariso', 2);
INSERT INTO centros_eventos VALUES (3, 'San Pedro Club', 3);

-- TIPOS ESCUELA
INSERT INTO tipos_escuela VALUES (1, 'Escuela de Música');
INSERT INTO tipos_escuela VALUES (2, 'Escuela de Teatro');
INSERT INTO tipos_escuela VALUES (3, 'Escuela de Artes');
...
-- ESTADOS CIVILES
INSERT INTO estados_civiles VALUES(1, 'Soltero');
INSERT INTO estados_civiles VALUES(2, 'Casado');
INSERT INTO estados_civiles VALUES(3, 'Viudo');

-- NACIONALIDADES
INSERT INTO nacionalidades VALUES(1, 'Chilena');
INSERT INTO nacionalidades VALUES(2, 'Argentina');
INSERT INTO nacionalidades VALUES(3, 'Peruana');

-- DIRECTORES

INSERT INTO directores VALUES
(1, 'Carlos', 'Andrés', 'Muñoz', 'Rojas', 'Av. Providencia 1234',
 'cmunoz@escuela.cl', 1, 1, 1, 1);

INSERT INTO directores VALUES
(2, 'María', NULL, 'Pérez', 'Lagos', 'Calle Marina 456',
 'mperez@escuela.cl', 2, 2, 2, 3);

INSERT INTO directores VALUES
(3, 'Juan', 'Pablo', 'Soto', 'Fuentes', 'Av. Michaihue 789',
 'jsoto@escuela.cl', 3, 3, 3, 3);

-- TELÉFONOS
INSERT INTO telefonos VALUES (1, '987654321', 1, 1);
INSERT INTO telefonos VALUES (2, '222111333', 2, 2);
INSERT INTO telefonos VALUES (3, '923456789', 1, 3);

-- ESCUELAS

INSERT INTO escuelas VALUES(1, 'Academia de Música Providencia', 'Av. Providencia 1200', 'https://eap.cl', 1, 1, 1, 1);
INSERT INTO escuelas VALUES(2, 'Escuela Artística Viña', 'Av. Borgoño 234', 'https://www.artesciudadjardin.cl', 2, 2, 2, 2);
INSERT INTO escuelas VALUES(3, 'Escuela de Teatro San Pedro', 'Av. Pedro Aguirre 890', 'https://www.teatrosanpedrito', 3, 3, 3, 3);
...
-- ISAPRES
INSERT INTO isapres VALUES (1, 'Fonasa');
INSERT INTO isapres VALUES (2, 'Banmédica');
INSERT INTO isapres VALUES (3, 'Consalud');

-- TIPOS INSTITUCIÓN
INSERT INTO tipos_institucion VALUES (1, 'Universidad');
INSERT INTO tipos_institucion VALUES (2, 'CFT');
INSERT INTO tipos_institucion VALUES (3, 'Instituto Profesional');
...
-- TIPO_CONTRATOS
INSERT INTO tipos_contrato VALUES (1, 'Planta');
INSERT INTO tipos_contrato VALUES (2, 'Honorarios');

-- ADJUDICACION_RECURSOS
insert into adjudicacion_recursos values (1, 3508, 34000000, null);
insert into adjudicacion_recursos values (2, 2422, 1500000, null);
...
INSERT INTO contratos VALUES (3,'FOLIO-003',380000,NULL,NULL,1,3,1);
INSERT INTO contratos VALUES (4,'FOLIO-004',390000,NULL,NULL,1,4,1);
INSERT INTO contratos VALUES (5,'FOLIO-005',750000,NULL,NULL,1,5,1);
INSERT INTO contratos VALUES (6,'FOLIO-006',NULL,11000,NULL,2,6,1);
INSERT INTO contratos VALUES (7,'FOLIO-007',NULL,13000,NULL,2,7,1);
INSERT INTO contratos VALUES (8,'FOLIO-008',550000,NULL,NULL,1,8,1);
INSERT INTO contratos VALUES (9,'FOLIO-009',NULL,14000,NULL,2,9,2);
INSERT INTO contratos VALUES (10,'FOLIO-010',590000,NULL,NULL,1,10,2);
INSERT INTO contratos VALUES (11,'FOLIO-011',450000,NULL,NULL,1,11,2);
INSERT INTO contratos VALUES (12,'FOLIO-012',NULL,15500,NULL,2,12,2);
INSERT INTO contratos VALUES (13,'FOLIO-013',380000,NULL,NULL,1,13,2);
INSERT INTO contratos VALUES (14,'FOLIO-014',420000,NULL,NULL,1,14,2);
INSERT INTO contratos VALUES (15,'FOLIO-015',600000,NULL,NULL,1,15,2);
INSERT INTO contratos VALUES (16,'FOLIO-016',570000,NULL,NULL,1,16,2);
INSERT INTO contratos VALUES (17,'FOLIO-017',NULL,13000,NULL,2,17,3);
INSERT INTO contratos VALUES (18,'FOLIO-018',NULL,13500,NULL,2,18,3);
INSERT INTO contratos VALUES (19,'FOLIO-019',420000,NULL,NULL,1,19,3);
INSERT INTO contratos VALUES (20,'FOLIO-020',690000,NULL,NULL,1,20,3);
INSERT INTO contratos VALUES (21,'FOLIO-021',NULL,10500,NULL,2,21,3);

-- FORMULARIOS
INSERT INTO formularios VALUES (1,'FOL-1001',null,null,1,1,1,1);
INSERT INTO formularios VALUES (2,'FOL-1002',null,null,2,2,2,2);
...
SELECT
    ...
    p.segundo_apellido as apellido_materno,
    -- CONCAT con más de 2 parámetros no funciona en la versión de oracleDB en oracle cloud:
...
JOIN tipos_institucion ti ON ti.id_tipo_institucion = ie.id_tipo_institucion
JOIN tipos_contrato tc ON tc.id_tipo_contrato = c.id_tipo_contrato
;
--*/
